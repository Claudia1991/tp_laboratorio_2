...
namespace Formulario
{
    public partial class Cuartel : Form
    {
        ...
        private delegate void FinalSalidaCallback(int index);

        public Cuartel()
        {
            InitializeComponent();

            salidasEnAccion = new List<Thread>();
        ...
        private void FinalDeSalida(int bomberoIndex)
        {
            ...
            {
                FinalSalidaCallback callback = new FinalSalidaCallback(FinalDeSalida);
